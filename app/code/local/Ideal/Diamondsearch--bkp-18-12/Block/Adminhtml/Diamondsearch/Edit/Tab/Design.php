  ...
  protected function _prepareForm()
  {
      ...
      $this->setForm($form);
		...
		$fieldset->addField('enable_captcha', 'select', array(
				'label'     => Mage::helper('diamondsearch')->__('Enable Captcha'),
				'name'      => 'enable_captcha',
				'value'  => Mage::getStoreConfig("diamondsearch/general_settings/enable_captcha"),
				'values' => array('0' => 'No', '1'=>'Yes'),
				'note' => 'in Details page'
		)); 
		
		$fieldset->addField('show_dont_see_what_you_want_button', 'select', array(
		'label'     => Mage::helper('diamondsearch')->__('Show dont see what you want button'),
		'name'      => 'show_dont_see_what_you_want_button',
		'value'  => Mage::getStoreConfig("diamondsearch/general_settings/show_dont_see_what_you_want_button"),
		'values' => array('0' => 'No', '1'=>'Yes'),
		'note' => 'in Search page'
		)); 
		
		$fieldset->addField('dont_see_what_you_want_button_link', 'text', array(
		'label'     => Mage::helper('diamondsearch')->__('Dont see What You Want Button Link'),
        'required'  => false,	
		'name'      => 'dont_see_what_you_want_button_link',
		'value'  => Mage::getStoreConfig("diamondsearch/general_settings/dont_see_what_you_want_button_link"),
		'note' => 'in Search page'
		)); 
		
		$fieldset->addField('image_text', 'text', array(
		'label'     => Mage::helper('diamondsearch')->__('Image Text'),
        'required'  => false,	
		'name'      => 'image_text',
		'value'  => Mage::getStoreConfig("diamondsearch/general_settings/image_text"),
		'note' => 'in Details page'
		)); 
		
		$fieldset->addField('show_cut_if_its_n', 'select', array(
		'label'     => Mage::helper('diamondsearch')->__('Show Cut if its N'),
		'name'      => 'show_cut_if_its_n',
		'value'  => Mage::getStoreConfig("diamondsearch/general_settings/show_cut_if_its_n"),
		'values' => array('0' => 'No', '1'=>'Yes'),
		'note' => 'in Search page, in Details page'
		));		

		
		$fieldset->addField('use_rapnet_instant_api_data', 'select', array(
		'label'     => Mage::helper('diamondsearch')->__('Use Rapnet Instant API Data'),
		'name'      => 'use_rapnet_instant_api_data',
		'value'  => Mage::getStoreConfig("diamondsearch/general_settings/use_rapnet_instant_api_data"),
		'values' => array('0' => 'No', '1'=>'Yes'),
		));
		$fieldset->addField('diamondsprice_min', 'text', array(
          'label'     => Mage::helper('diamondsearch')->__('Price Min'),
          'required'  => false,
          'name'      => 'diamondsprice_min',
          'value'  => Mage::getStoreConfig("diamondsearch/general_settings/diamondsprice_min"),
			'note' => 'Only for Rapnet Instant API. "Use Rapnet Instant API Data" must be set to Yes'
        ));   
		$fieldset->addField('diamondsprice_max', 'text', array(
          'label'     => Mage::helper('diamondsearch')->__('Price Max'),
          'required'  => false,
          'name'      => 'diamondsprice_max',
          'value'  => Mage::getStoreConfig("diamondsearch/general_settings/diamondsprice_max"),
			'note' => 'Only for Rapnet Instant API. "Use Rapnet Instant API Data" must be set to Yes'
        ));   
	...
	$fieldset->addField('table_header_textcolor', 'colorpicker', array(
      ...
      $fieldset->addField('view_button_hover_textcolor', 'colorpicker', array(
          'label'     => Mage::helper('diamondsearch')->__('View Button Hover Text Color'),
          'name'      => 'view_button_hover_textcolor',
		  'value'	  => Mage::getStoreConfig("diamondsearch/design_settings/view_button_hover_textcolor")
      ));
