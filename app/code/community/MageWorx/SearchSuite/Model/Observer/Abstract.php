        ...
        foreach ($order as $key => $item) {
            if ($item[0] == 'relevance') {
                ...
                $collection->getSelect()
                    ...
                    ->joinLeft(
                        array('decimal_attributes' => Mage::getSingleton('core/resource')->getTableName('catalog_product_entity_decimal')),
                        "decimal_attributes.attribute_id=attributes.attribute_id AND e.entity_id=decimal_attributes.entity_id  AND decimal_attributes.store_id=$storeId ",
                        array(
