 ...
 */
class Ideal_DynCatProd_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public Function attributesOptionArray() {
    	...
    	->addFieldToFilter('used_for_dyncatprod_by',array('eq' => 1))
    	->addSetInfo();
    	foreach($attributes as $attributesdata)
    	{
    		$options[$attributesdata['attribute_id']] = $attributesdata['frontend_label'];
    	}
    	return $options;
