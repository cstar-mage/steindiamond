...
//            $this->_registerSynonymsCollection($block->getCollection());
    ...
    public function catalogProductCollectionLoadBefore($observer) {
        ...
        if (!$parameter && ($collection instanceof Mage_CatalogSearch_Model_Resource_Fulltext_Collection || $collection instanceof Mage_CatalogSearch_Model_Mysql4_Fulltext_Collection || $collection instanceof MageWorx_SearchSuite_Model_Resource_CatalogSearch_Fulltext_Collection)) {
