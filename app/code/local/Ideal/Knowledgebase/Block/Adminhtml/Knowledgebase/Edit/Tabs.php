...
class Ideal_Knowledgebase_Block_Adminhtml_Knowledgebase_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
	  ...
	  $this->addTab('form_section', array(
      		'label'     => Mage::helper('knowledgebase')->__('Advice and answers'),
      		'title'     => Mage::helper('knowledgebase')->__('Advice and answers'),
      		'content'   => $this->getLayout()->createBlock('knowledgebase/adminhtml_knowledgebase_edit_tab_answers')->toHtml(),
      ));
