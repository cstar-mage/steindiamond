...
class Mage_Uploadtool_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function alterMissingColumns() {
		...
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo2", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo3", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo4", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo5", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo6", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo7", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo8", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "photo9", "TEXT NULL" );
		...
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "lab_comments", "TEXT NULL" );
		$this->add_column_if_not_exist($uploadtool_diamonds_inventory, "dealer_comments", "TEXT NULL" );
	}
	...
	public function add_column_if_not_exist($table, $column, $column_attr = "VARCHAR( 255 ) NULL" ){
		...
		$magento_connection = mysqli_connect($magento_db, $mdb_user, $mdb_passwd);
		if (!$magento_connection)
		{
			die('Unable to connect to the database');
		}
		mysqli_select_db($magento_connection,$mdb_name) or die ("Database not found.");
	...
	public function getImportCSV() {
		try
		{
			...
			*/
			...
			curl_setopt($ch,CURLOPT_URL,"http://www.jewelerslink.com/uploader/index/getNewJson");
		...
		try
		{
			...
			while($csv_line = fgetcsv($fp))
			{
				...
				$qstring = "insert into `$uploadtool_diamonds_inventory` SET
							...
							photo8 = '".$csv_line[72]."',
							photo9 = '".$csv_line[73]."',
							culet_condition = '".$csv_line[74]."',
							lab_comments = '".$csv_line[75]."',
							dealer_comments = '".$csv_line[76]."',
							source = 'jewelerslink'";
	...
	public function applyPriceIncrease($source) {
		...
		{	
				...
				for($i=0; $i<100; $i++)
					...
					if(isset($price_increase_final[$i]) && ($price_increase_final[$i] != '')) {
						$query_update = "UPDATE `$uploadtool_diamonds_inventory` SET `totalprice` = cost*".$price_increase_final[$i]." where (`cost` BETWEEN ".$price_from[$i]." AND ".$price_to[$i] . ") ";
						if($source=="rapnet"){
							$query_update .= " AND (`source` = 'rapnet' OR `source` = 'rapnet_inst')";
						}
						else {
							$query_update .= " AND `source` = '".$source."'";
						}
		...
		//removing JL increase as it's implemented at JL
		/*
		if($source == 'jewelerslink')
		{
			$uploadtool_vendor = Mage::getSingleton("core/resource")->getTableName('uploadtool_vendor');
	...
	public function updateRows() {
		...
		//new shapes from diamondalternatives.com
		$new_shapes_array = array(
			array(
				"Amora_Gem_Asscher" => array("Amora_Gem_AS"),
				"Amora_Gem_Cushion" => array("Amora_Gem_CU"),
				"Amora_Gem_Emerald" => array("Amora_Gem_EM"),
				"Amora_Gem_Heart" => array("Amora_Gem_HS"),
				"Amora_Gem_Marquise" => array("Amora_Gem_MQ"),
				"Amora_Gem_Oval" => array("Amora_Gem_OV"),
				"Amora_Gem_Pear" => array("Amora_Gem_PS"),
				"Amora_Gem_Radiant" => array("Amora_Gem_RA"),
				"Amora_Gem_Princess" => array("Amora_Gem_SB"),
				"Amora_Gem_Round" => array("Amora_Gem_RB")
			),
			array(
				"Lab_Grown_Diamond_Asscher" => array("Lab_Grown_Diamonds_AS", "Lab_Grown_Diamond_AS"),
				"Lab_Grown_Diamond_Cushion" => array("Lab_Grown_Diamonds_CU", "Lab_Grown_Diamond_CU"),
				"Lab_Grown_Diamond_Emerald" => array("Lab_Grown_Diamonds_EM", "Lab_Grown_Diamond_EM"),
				"Lab_Grown_Diamond_Heart" => array("Lab_Grown_Diamonds_HS", "Lab_Grown_Diamond_HS"),
				"Lab_Grown_Diamond_Marquise" => array("Lab_Grown_Diamonds_MQ", "Lab_Grown_Diamond_MQ"),
				"Lab_Grown_Diamond_Oval" => array("Lab_Grown_Diamonds_OV", "Lab_Grown_Diamond_OV"),
				"Lab_Grown_Diamond_Pear" => array("Lab_Grown_Diamonds_PS", "Lab_Grown_Diamond_PS"),
				"Lab_Grown_Diamond_Radiant" => array("Lab_Grown_Diamonds_RA", "Lab_Grown_Diamond_RA"),
				"Lab_Grown_Diamond_Princess" => array("Lab_Grown_Diamonds_SB", "Lab_Grown_Diamond_SB"),
				"Lab_Grown_Diamond_Round" => array("Lab_Grown_Diamonds_RB", "Lab_Grown_Diamond_RB")
			),
			array(
				"DIAMELIA_Asscher" => array("DIAMELIA_AS"),
				"DIAMELIA_Cushion" => array("DIAMELIA_CU"),
				"DIAMELIA_Emerald" => array("DIAMELIA_EM"),
				"DIAMELIA_Heart" => array("DIAMELIA_HS"),
				"DIAMELIA_Marquise" => array("DIAMELIA_MQ"),
				"DIAMELIA_Oval" => array("DIAMELIA_OV"),
				"DIAMELIA_Pear" => array("DIAMELIA_PS"),
				"DIAMELIA_Radiant" => array("DIAMELIA_RA"),
				"DIAMELIA_Princess" => array("DIAMELIA_SB"),
				"DIAMELIA_Round" => array("DIAMELIA_RB")
			),
			array(
				"Forever_One_Moissanite_Asscher" => array("Forever_One_Moissanite_AS"),
				"Forever_One_Moissanite_Cushion" => array("Forever_One_Moissanite_CU"),
				"Forever_One_Moissanite_Emerald" => array("Forever_One_Moissanite_EM"),
				"Forever_One_Moissanite_Heart" => array("Forever_One_Moissanite_HS"),
				"Forever_One_Moissanite_Marquise" => array("Forever_One_Moissanite_MQ"),
				"Forever_One_Moissanite_Oval" => array("Forever_One_Moissanite_OV"),
				"Forever_One_Moissanite_Pear" => array("Forever_One_Moissanite_PS"),
				"Forever_One_Moissanite_Radiant" => array("Forever_One_Moissanite_RA"),
				"Forever_One_Moissanite_Princess" => array("Forever_One_Moissanite_SB"),
				"Forever_One_Moissanite_Round" => array("Forever_One_Moissanite_RB")
			),
			array(
				"True_Light_Asscher" => array("True_Light_AS"),
				"True_Light_Cushion" => array("True_Light_CU"),
				"True_Light_Emerald" => array("True_Light_EM"),
				"True_Light_Heart" => array("True_Light_HS"),
				"True_Light_Marquise" => array("True_Light_MQ"),
				"True_Light_Oval" => array("True_Light_OV"),
				"True_Light_Pear" => array("True_Light_PS"),
				"True_Light_Radiant" => array("True_Light_RA"),
				"True_Light_Princess" => array("True_Light_SB"),
				"True_Light_Round" => array("True_Light_RB")
			),
			array(
				"Pure_Light_Asscher" => array("Pure_Light_AS"),
				"Pure_Light_Cushion" => array("Pure_Light_CU"),
				"Pure_Light_Emerald" => array("Pure_Light_EM"),
				"Pure_Light_Heart" => array("Pure_Light_HS"),
				"Pure_Light_Marquise" => array("Pure_Light_MQ"),
				"Pure_Light_Oval" => array("Pure_Light_OV"),
				"Pure_Light_Pear" => array("Pure_Light_PS"),
				"Pure_Light_Radiant" => array("Pure_Light_RA"),
				"Pure_Light_Princess" => array("Pure_Light_SB"),
				"Pure_Light_Round" => array("Pure_Light_RB")
			),
			array(
				"SuperNova_Asscher" => array("SuperNova_AS"),
				"SuperNova_Cushion" => array("SuperNova_CU"),
				"SuperNova_Emerald" => array("SuperNova_EM"),
				"SuperNova_Heart" => array("SuperNova_HS"),
				"SuperNova_Marquise" => array("SuperNova_MQ"),
				"SuperNova_Oval" => array("SuperNova_OV"),
				"SuperNova_Pear" => array("SuperNova_PS"),
				"SuperNova_Radiant" => array("SuperNova_RA"),
				"SuperNova_Princess" => array("SuperNova_SB"),
				"SuperNova_Round" => array("SuperNova_RB")
			),
			array(
				"HA_Moissanite_Asscher" => array("HA_Moissanite_AS"),
				"HA_Moissanite_Cushion" => array("HA_Moissanite_CU"),
				"HA_Moissanite_Emerald" => array("HA_Moissanite_EM"),
				"HA_Moissanite_Heart" => array("HA_Moissanite_HS"),
				"HA_Moissanite_Marquise" => array("HA_Moissanite_MQ"),
				"HA_Moissanite_Oval" => array("HA_Moissanite_OV"),
				"HA_Moissanite_Pear" => array("HA_Moissanite_PS"),
				"HA_Moissanite_Radiant" => array("HA_Moissanite_RA"),
				"HA_Moissanite_Princess" => array("HA_Moissanite_SB"),
				"HA_Moissanite_Round" => array("HA_Moissanite_RB")
			)
		);
		
		foreach($new_shapes_array as $new_shapes){
			foreach($new_shapes as $shp => $new_shape){
				$qr = "update `$uploadtool_diamonds_inventory` set `shape` = '$shp' where `shape` in ('". implode("','", $new_shape)."')";
				mysql_query($qr) or die(mysql_error());
			}
		}
		
		mysql_query("DELETE FROM `$uploadtool_diamonds_inventory` WHERE `shape` NOT IN ('ROUND', 'PRINCESS', 'EMERALD', 'ASSCHER', 'MARQUISE', 'OVAL', 'RADIANT', 'PEAR', 'CUSHION', 'HEART', 'TRIANGULAR', 'TRILLIANT', 'TRILLION', 'OLD_EUROPEAN', 'VINTAGE_CUSHION', 'RECTANGULAR_VINTAGE_CUSHION', 'ascendancy_heart_arrows', 'platinum_select_round', 'august_vintage_european', 'the_solasfera_diamond', 'the_star_129', 'the_eighternity_diamond', 'august_vintage_cushion', 'august_vintage_star', 'platinum_select_vintage', 'platinum_select_modern', 'brellia_cushion_hearts', 'the_octavia_asscher', 'the_solasfera_princess', 'platinum_select_princess', 'ideal2_hearts_arrows', 'Amora_Gem', 'Lab_Grown_Diamond', 'DIAMELIA', 'Forever_One_Moissanite', 'True_Light', 'Pure_Light', 'SuperNova', 'DIAMELIA_Asscher', 'DIAMELIA_Cushion', 'DIAMELIA_Emerald', 'DIAMELIA_Heart', 'DIAMELIA_Marquise', 'DIAMELIA_Oval', 'DIAMELIA_Pear', 'DIAMELIA_Radiant', 'DIAMELIA_Princess', 'DIAMELIA_Round', 'SuperNova_Round', 'SuperNova_Asscher', 'SuperNova_Cushion', 'SuperNova_Emerald', 'SuperNova_Heart', 'SuperNova_Marquise', 'SuperNova_Oval', 'SuperNova_Pear', 'SuperNova_Radiant', 'SuperNova_Princess', 'Amora_Gem_Asscher', 'Amora_Gem_Cushion', 'Amora_Gem_Emerald', 'Amora_Gem_Heart', 'Amora_Gem_Marquise', 'Amora_Gem_Oval', 'Amora_Gem_Pear', 'Amora_Gem_Radiant', 'Amora_Gem_Princess', 'Amora_Gem_Round', 'Lab_Grown_Diamond_Asscher', 'Lab_Grown_Diamond_Cushion', 'Lab_Grown_Diamond_Emerald', 'Lab_Grown_Diamond_Heart', 'Lab_Grown_Diamond_Marquise', 'Lab_Grown_Diamond_Oval', 'Lab_Grown_Diamond_Pear', 'Lab_Grown_Diamond_Radiant', 'Lab_Grown_Diamond_Princess', 'Lab_Grown_Diamond_Round', 'Forever_One_Moissanite_Asscher', 'Forever_One_Moissanite_Cushion', 'Forever_One_Moissanite_Emerald', 'Forever_One_Moissanite_Heart', 'Forever_One_Moissanite_Marquise', 'Forever_One_Moissanite_Oval', 'Forever_One_Moissanite_Pear', 'Forever_One_Moissanite_Radiant', 'Forever_One_Moissanite_Princess', 'Forever_One_Moissanite_Round', 'True_Light_Asscher', 'True_Light_Cushion', 'True_Light_Emerald', 'True_Light_Heart', 'True_Light_Marquise', 'True_Light_Oval', 'True_Light_Pear', 'True_Light_Radiant', 'True_Light_Princess', 'True_Light_Round', 'Pure_Light_Asscher', 'Pure_Light_Cushion', 'Pure_Light_Emerald', 'Pure_Light_Heart', 'Pure_Light_Marquise', 'Pure_Light_Oval', 'Pure_Light_Pear', 'Pure_Light_Radiant', 'Pure_Light_Princess', 'Pure_Light_Round', 'HA_Moissanite_Asscher', 'HA_Moissanite_Cushion', 'HA_Moissanite_Emerald', 'HA_Moissanite_Heart', 'HA_Moissanite_Marquise', 'HA_Moissanite_Oval', 'HA_Moissanite_Pear', 'HA_Moissanite_Radiant', 'HA_Moissanite_Princess', 'HA_Moissanite_Round', 'HA_Moissanite')") or die(mysql_error());
		...
		mysql_query("update `$uploadtool_diamonds_inventory` set `cut` = 'HA' where `cut` IN ('H&A','Hearts & Arrows Ideal','Heart')");
		mysql_query("update `$uploadtool_diamonds_inventory` set `cut` = 'BLAZING_ARROWS' where `cut` IN ('BLAZING ARROWS')");
		...
		$imageFields = array('image', 'diamond_image', 'frontviewimage', 'sideviewimage', 'gasviewimage', 'girdleviewimage', 'giacertimage', 'eglcertimage', 'certificate_url', 'photo2', 'photo3', 'photo4', 'photo5', 'photo6', 'photo7', 'photo8', 'photo9');
	...
	public function getRapnetInstantInvList() {
		try
		{
			$user = Mage::helper('uploadtool')->diamondSettings('rapnet_username');
			$passwd = Mage::helper('uploadtool')->diamondSettings('rapnet_password');
			...
			$finalCsv = array();
			$finalCsv[] = array("Owner", "Shape", "Carat", "Color", "Fancy Color", "Fancy Intensity", "Fancy Overtone", "Clarity", "Cut", "Polish", "Symmetry", "Fluorescence Color", "Fluorescence Intensity", "Measurements", "Meas Length", "Meas Width", "Meas Depth", "Lab", "Certificate #", "Stock #", "Total Price", "Depth %", "Table %", "Girdle Thin", "Girdle Thick", "Culet");
			...
			$continue_loop = true;
			do{
				$response = $this->getRapnetInstantInvAPIResponse($user,$passwd,$page_number,$page_size,$search_type);
				if($response["response"]["header"]["error_code"]!=0){
					if(count($finalCsv)>1) break;
					else return array("success"=>0,"message"=>$response["response"]["header"]["error_message"]);
				}
				foreach($response["response"]["body"]["diamonds"] as $diamond){
					$finalCsv[] = array(
						...
						$diamond["meas_length"]."x".$diamond["meas_width"]."x".$diamond["meas_depth"],
						$diamond["meas_length"],
						$diamond["meas_width"],
						$diamond["meas_depth"],
						$diamond["lab"],
				...
				$diamonds_returned = $response["response"]["body"]["search_results"]["diamonds_returned"];
				$total_diamonds_found = $response["response"]["body"]["search_results"]["total_diamonds_found"];
				
				$total_pages = ceil($total_diamonds_found/$page_size);
				//echo "<pre>";	print_r($response);	exit;
				//echo "<li>".$diamonds_returned."</li>";
				$page_number++;
				//if($page_number >= 6+1){$continue_loop = false;}
				if($page_number >= $total_pages+1){$continue_loop = false;}
			}while($continue_loop);
			
			//Same code for FANCY diamonds
			$page_number = 1;
			$page_size = 50;
			$total_pages = 0;
			$search_type = "Fancy";
			...
			//ENDS Same code for FANCY diamonds
			
			//echo "sffS<pre>";print_r($finalCsv);exit;
			$path = Mage::getBaseDir().DS."/var/import".DS."rapnet".DS;
			$fp = fopen($path."rapnet_inst.csv", "w") or die("can't open file");
	...
	public function getRapnetInstantInvAPIResponse($user,$passwd,$page_number=1,$page_size=50,$search_type="White"){
		$data_string = '{
			"request": {
				"header": {
					"username": "'.$user.'",
	...
	public function updateRapnetInstantInvDiamonds() {
		ini_set('memory_limit','-1');
		ini_set('auto_detect_line_endings',TRUE);
		...
		try
		{
			...
			$path = Mage::getBaseDir("var") . DS ."import/rapnet" . DS;
			$fp = fopen($path."rapnet_inst.csv",'r') or die("can't open rapnet file");
			
			mysql_query("Delete from $uploadtool_diamonds_inventory where source = 'rapnet_inst'") or die(mysql_error());
			...
			$sql = "select count(lotno) from $uploadtool_diamonds_inventory  where source = 'rapnet_inst'";
			$result = mysql_query($sql);
			$row = mysql_fetch_row($result);
			$count = $row[0];
		
			return array("success"=>1,"message"=>$count." Diamond(s) Inserted from Rapnet Instant API.");
		}
		catch (Exception $e) {
			return array("success"=>0,"message"=>$e->getMessage());
		}	
	...
	public function importGoogle() {
		...
		try
		{
			...
			$videoMyCaseArray = explode ( ",", str_replace ( " ", "", strtoupper ( Mage::getStoreConfig ( 'uploadtool/csv_title_possibilities/image_or_video_link' ) ) ) );
			...
			while($csv_line = fgetcsv($fp)){
				if($row==0){
					...
					foreach ( $currentHeaders as $key => $headerTitle ) {
						...
						if (in_array ( $headerTitle, $videoMyCaseArray )) {
							$videoKey = $key;
						}
				...
				//video
				$video = "";
				if(isset($csv_line[$videoKey])) {
					$video = $csv_line[$videoKey];
				}
				...
				$qstring = "insert into `$uploadtool_diamonds_inventory` SET
						...
						diamond_image = '".mysql_real_escape_string($dimage)."',
						image_or_video_link = '".mysql_real_escape_string($video)."',
						source = 'google'";
				mysql_query($qstring) or die(mysql_error());
				//echo $qstring; exit;
			}
