	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$config -> saveConfig('diamondsearch/general_settings/enable_captcha', $data["enable_captcha"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/use_rapnet_instant_api_data', $data["use_rapnet_instant_api_data"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/diamondsprice_min', $data["diamondsprice_min"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/diamondsprice_max', $data["diamondsprice_max"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/show_dont_see_what_you_want_button', $data["show_dont_see_what_you_want_button"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/dont_see_what_you_want_button_link', $data["dont_see_what_you_want_button_link"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/image_text', $data["image_text"] , 'default', $storeId);
				$config -> saveConfig('diamondsearch/general_settings/show_cut_if_its_n', $data["show_cut_if_its_n"] , 'default', $storeId);
				...
				$config -> saveConfig('diamondsearch/design_settings/view_button_hover_textcolor', $data["view_button_hover_textcolor"] , 'default', $storeId);
