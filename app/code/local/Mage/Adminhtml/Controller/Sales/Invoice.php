...
class Mage_Adminhtml_Controller_Sales_Invoice extends Mage_Adminhtml_Controller_Action
{
    ...
    public function printAction()
    {
        ...
        if ($invoicesIds = $this->getRequest()->getParam('invoice_id')) {
          /*  if ($invoice = Mage::getModel('sales/order_invoice')->load($invoiceId)) {
            ...
            $invoices = Mage::getResourceModel('sales/order_invoice_collection')
			   ...
			   $invoice = Mage::getModel('sales/order_invoice')->load($invoicesIds);
			   ...
			   $order = $order->getData();
				...
				return $this->_prepareDownloadResponse($order['customer_firstname'].'-'.$order['customer_lastname'].'-'.$order['increment_id'].
					'.pdf', $pdf->render(), 'application/pdf');
			}
       }
        else {
