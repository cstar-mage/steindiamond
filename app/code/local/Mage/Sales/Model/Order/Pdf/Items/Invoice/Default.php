...
class Mage_Sales_Model_Order_Pdf_Items_Invoice_Default extends Mage_Sales_Model_Order_Pdf_Items_Abstract
{
    ...
    public function draw()
    {
		...
		// draw Product Image
        //$lines[0] = array(array(
            //'image' => Mage::helper('core/string')->str_split($item->getImage(), 15, true, true),
            //'feed' => 15,
        //));
        ...
        // draw Product name
        $lines[0] = array(array(
            'text' => Mage::helper('core/string')->str_split($item->getName(), 35, true),
            'feed' => 75
        ));
