    ...
    b.DEFAULTS = {
        ...
        function h(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild; i;) {
                    var j = i.nextSibling;
                    if (i.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(i) || b.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) >= 0 && !b.node.hasClass(i, "fr-marker")))g = null, f.appendChild(i); else if (i.nodeType != Node.ELEMENT_NODE && i.nodeType != Node.TEXT_NODE)g = null, f.appendChild(i); else if ("BR" == i.tagName)j && "BR" == j.tagName && (j = j.nextSibling), null == g ? (g = b.doc.createElement(e), d && g.setAttribute("data-empty", !0), g.appendChild(i), f.appendChild(g)) : h === !1 && (g.appendChild(b.doc.createElement("br")), g.setAttribute("data-empty", !0)), g = null; else {
                        var k = i.textContent;
        ...
        function n(a) {
            ...
            for (var c = b.doc.createTreeWalker(a, NodeFilter.SHOW_TEXT, b.node.filter(function (a) {
                ...
                var d = c.currentNode, e = b.node.isBlock(d.parentNode) || b.node.isElement(d.parentNode), f = d.textContent.replace(/(?!^)( ){2,}(?!$)/g, " ").replace(/\n/g, " ").replace(/^[ ]{2,}/g, " ").replace(/[ ]{2,}$/g, " ");
                if (e) {
        ...
        function A(a, c) {
            ...
            if (!b.opts.useClasses && !c) {
                ...
                for (e = 0; e < b.doc.styleSheets.length; e++) {
                    ...
                    if (j)for (var m = 0, n = j.length; m < n; m++)if (j[m].selectorText && j[m].style.cssText.length > 0) {
                ...
                for (e = 0; e < g.length; e++)if (g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")), g[e].removeAttribute("class")), (g[e].getAttribute("fr-original-style") || "").trim().length > 0)for (var w = g[e].getAttribute("fr-original-style").split(";"), r = 0; r < w.length; r++)w[r].indexOf(":") > 0 && (g[e].style[w[r].split(":")[0].trim()] = w[r].split(":")[1].trim())
            }
        ...
        function F(a, c, d) {
            b.selection.isCollapsed() || b.selection.remove();
            var e;
            if (e = c ? a : b.clean.html(a), e = e.replace(/\r|\n/g, " "), a.indexOf('class="fr-marker"') < 0 && (e = D(e)), b.core.isEmpty() && !b.opts.keepFormatOnDelete)b.el.innerHTML = e; else {
                var f = b.markers.insert();
                if (f) {
        ...
        function l(e, g, h) {
            if (b.shared.$f_el) {
                ...
                var j = e.find("button:visible:not(.fr-disabled), .fr-group span.fr-command:visible"), l = j.index(b.shared.$f_el);
        ...
        function h() {
            ...
            if (b.opts.pastePlain && (m = g(m)), d = b.events.chainTrigger("paste.afterCleanup", m), "string" == typeof d && (m = d), "" !== m) {
                ...
                var r = l.children;
                if (1 == r.length && ["OL", "UL"].indexOf(r[0].tagName) && (r[0].outerHTML = r[0].innerHTML), !h)for (var s = l.getElementsByTagName("br"), p = 0; p < s.length; p++) {
                    var t = s[p];
        ...
        function j(a) {
            ...
            for (var f = c.querySelectorAll(":scope > div:not([style]), td > div, th > div, li > div"); f.length;) {
                var g = f[f.length - 1];
                if (b.html.defaultTag() && "div" != b.html.defaultTag())g.outerHTML = "<" + b.html.defaultTag() + ">" + g.innerHTML + "</" + b.html.defaultTag() + ">"; else {
        ...
        function c(c) {
            var d = c.next(), e = b.node.hasClass(c.get(0), "fr-active"), f = (b.helpers.isMobile(), a(".fr-dropdown.fr-active").not(c)), g = c.parents(".fr-toolbar, .fr-popup").data("instance") || b;
