...
class MageWorx_SearchSuite_Adminhtml_Mageworx_Searchsuite_SynonymsController extends Mage_Adminhtml_Controller_Action {
    ...
    public function editAction() {
        ...
        $this->_addBreadcrumb($this->_getLabel($id), $this->_getTitle($id));
        $this->renderLayout();
    }
     ...
     * @return string
     */
    protected function _getLabel($id)
    {
        if ($id) {
            return Mage::helper('mageworx_searchsuite')->__('Edit Synonyms');
        }
        return Mage::helper('mageworx_searchsuite')->__('Add new synonyms');
    }
