...
class Mage_Stud_Block_Adminhtml_Stud_Edit_Tab_Design extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  $fieldset->addType('colorpicker', Mage::getConfig()->getBlockClassName('Mage_Stud_Block_Adminhtml_Stud_Edit_Renderer_Color'));
