...
{	
	...
	public function saveAction() {	
		try{
			...
			$config -> saveConfig('stud/general_settings/14k_white_gold', $post["14k_white_gold"] , 'default', $storeId);
			$config -> saveConfig('stud/general_settings/14k_yellow_gold', $post["14k_yellow_gold"] , 'default', $storeId);
			$config -> saveConfig('stud/general_settings/14k_rose_gold', $post["14k_rose_gold"] , 'default', $storeId);
			$config -> saveConfig('stud/general_settings/18k_white_gold', $post["18k_white_gold"] , 'default', $storeId);
			$config -> saveConfig('stud/general_settings/18k_yellow_gold', $post["18k_yellow_gold"] , 'default', $storeId);
			$config -> saveConfig('stud/general_settings/18k_rose_gold', $post["18k_rose_gold"] , 'default', $storeId);
