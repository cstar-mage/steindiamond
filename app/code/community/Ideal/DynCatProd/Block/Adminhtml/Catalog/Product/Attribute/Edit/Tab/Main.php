 ...
 */
class Ideal_DynCatProd_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('used_for_sort_by', 'select', array(
            ...
            'label'     => Mage::helper('catalog')->__('Used for Sorting in Product Listing 1'),
            'title'     => Mage::helper('catalog')->__('Used for Sorting in Product Listing 1'),
            'note'      => Mage::helper('catalog')->__('Depends on design theme'),
            'values'    => $yesnoSource,
        ));
